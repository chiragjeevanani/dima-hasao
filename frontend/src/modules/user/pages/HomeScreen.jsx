...
export const HomeScreen = () => {
  ...
  const { setIsNotificationsOpen, showToast } = useBooking();

  return (
    <div className="text-gray-800 pb-20 relative bg-[#FDFBF7] min-h-screen">
      {/* BEGIN: Header Section */}
      <header
        className="relative w-full h-[255px] sm:h-[270px] overflow-hidden rounded-b-2xl shadow-xs"
      ...
      >
        ...
        <div className="absolute inset-0 w-full h-full">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-white/70 via-transparent to-black/30 pointer-events-none" />
        </div>
        ...
        <div className="absolute top-3 left-3 right-3 flex justify-between items-center z-20">
          <motion.button
            ...
            className="w-8 h-8 bg-[#06381e] text-white rounded-full flex items-center justify-center shadow-md border border-white/30 backdrop-blur-xs hover:bg-[#094c2a] transition-colors cursor-pointer"
          >
          ...
          <motion.button
            ...
            className="w-8 h-8 bg-[#06381e] text-white rounded-full flex items-center justify-center shadow-md border border-white/30 backdrop-blur-xs relative hover:bg-[#094c2a] transition-colors cursor-pointer"
          >
        ...
        <div className="absolute top-8 left-3 right-3 z-10 flex items-center justify-center gap-3">
          {/* Official Round Seal Logo */}
          <div className="w-[84px] h-[84px] sm:w-[92px] sm:h-[92px] rounded-full shadow-lg border-2 border-amber-400 overflow-hidden bg-white shrink-0">
            <img
          ...
          <div className="flex flex-col text-left drop-shadow-xs">
            {/* JHUTHAI! in festive colorful letters */}
            ...
            {/* WELCOME TO with lines */}
            <div className="flex items-center gap-1.5 my-0.5">
              <div className="h-[1px] bg-[#06381e]/60 w-5"></div>
              <p className="text-[8.5px] sm:text-[9px] font-black tracking-widest text-[#06381e] uppercase">
                WELCOME TO
              </p>
              <div className="h-[1px] bg-[#06381e]/60 w-5"></div>
            </div>
            ...
            {/* DIMA HASAO */}
            <h1 className="font-montserrat text-xl sm:text-2xl font-black text-[#06381e] leading-none tracking-tight">
              DIMA HASAO
            </h1>

            {/* Subtitle */}
            <p className="text-[#06381e] font-serif font-semibold italic text-[10.5px] sm:text-xs mt-0.5">
      ...
      <main className="space-y-3 pt-2" data-purpose="main-content">
        ...
        <div className="grid grid-cols-3 gap-2 px-3" data-purpose="primary-categories">
          ...
          <CategoryCard
            ...
            onClick={() => {
              showToast('Viewing verified homestays & hotels in Dima Hasao');
              navigate('/places/1');
            }}
          />
        </div>

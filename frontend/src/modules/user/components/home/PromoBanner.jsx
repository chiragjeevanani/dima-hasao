...
export const PromoBanner = () => {
  ...
  return (
    <div className="relative w-auto mx-3 h-[110px] rounded-2xl overflow-hidden shadow-xs border border-orange-200/40" data-purpose="promo-banner">
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-r from-amber-500/30 via-transparent to-transparent pointer-events-none"></div>

      {/* Left Typography & CTA */}
      <div className="absolute inset-y-0 left-0 p-3 flex flex-col justify-center w-3/5 z-10">
        <h3 className="text-gray-900 font-extrabold text-[11px] sm:text-xs leading-tight mb-2 drop-shadow-xs tracking-tight">
          DISCOVER THE<br />
          UNTOLD BEAUTY OF<br />
        ...
        <motion.button
          ...
          className="bg-[#084524] hover:bg-emerald-800 text-white text-[8.5px] font-bold py-1 px-2.5 rounded-full w-max flex items-center gap-1 shadow-md cursor-pointer border border-white/20"
        >
      ...
      <div className="absolute right-2.5 top-1/2 -translate-y-1/2 flex -space-x-3 z-10 pointer-events-none">
        <div className="w-12 h-12 rounded-full border-2 border-white overflow-hidden shadow-md bg-white">
          <img
            alt="Waterfall"
            className="w-full h-full object-cover"
        ...
        <div className="w-14 h-14 rounded-full border-2 border-white overflow-hidden shadow-lg z-10 bg-white">
          <img
            alt="Traditional Hut"
            className="w-full h-full object-cover"
